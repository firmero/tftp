...
void print_info(struct sockaddr_storage* saddr_st, char* filename, char* mode, enum SS wr);
...
extern pthread_cond_t  cond; // signal when is node unregistred from list
extern char*           dir;
